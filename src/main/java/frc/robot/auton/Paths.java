...
public class Paths {
	...
	public static final class ReferencePoints{
		...
		public static final Pose2d redRight2Pose = new Pose2d(new Translation2d(13.28, 4.65), rot2dDeg(0));
		public static final Pose2d redLeft1Pose = new Pose2d(new Translation2d(10.25, 0.75), rot2dDeg(0));
		public static final Pose2d redLeft2Pose = new Pose2d(new Translation2d(13.28, 0.75), rot2dDeg(0));
