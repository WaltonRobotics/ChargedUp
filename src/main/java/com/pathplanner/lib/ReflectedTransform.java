 ...
 */
public class ReflectedTransform {
     ...
     */
    // @SneakyThrows
    public static PathPlannerState reflectiveTransformState(PathPlannerState state) {
        ...
        Translation2d transformedTranslation = new Translation2d(
                PathPlannerUtil.FIELD_HEIGHT_METERS - state.poseMeters.getX(), state.poseMeters.getY());
        ...
        // curveRadiusField.set(transformedState, (-1) * (Double)
        // curveRadiusField.get(state));
