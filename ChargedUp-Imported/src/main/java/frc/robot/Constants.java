...
public final class Constants {
	...
	public static final class SwerveK {
		...
		public static final class Mod0 {
			...
			public static final Rotation2d angleOffset = Rotation2d.fromDegrees(4.482422);
		...
		public static final class Mod1 {
			...
			public static final Rotation2d angleOffset = Rotation2d.fromDegrees(148.007812);
			public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID,
					angleMotorID,
					canCoderID, angleOffset);
		}
		...
		public static final class Mod2 {
			...
			public static final Rotation2d angleOffset = Rotation2d.fromDegrees(73.212891);
			public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID,
					angleMotorID,
					canCoderID, angleOffset);
		}
		...
		public static final class Mod3 {
			...
			public static final Rotation2d angleOffset = Rotation2d.fromDegrees(273.779297);
			public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID,
					angleMotorID,
					canCoderID, angleOffset);
		}
	...
	public static final class TiltK {
		public static final String kDbTabName = "TiltSubsys";
		// 199.83 start tilt
		...
		public static final int kMotorCurrLimit = 40;
		...
		public static final double kMaxVelocity = 400; // degrees per sec
		public static final double kMaxAcceleration = 800.0; // degrees per sec squared
		...
		public static final double kGearRatio = ((5.0 / 1.0) * (37.0 / 21.0));
	...
	public static final class VisionK {
		...
		// 		new Translation3d(Units.inchesToMeters(-2.34375), Units.inchesToMeters(11.46875),
		// 				Units.inchesToMeters(17.375)),
		// 		new Rotation3d(0, Units.degreesToRadians(0), 0));

		// private static final Transform3d rightCornerLow_RobotToCamera = new Transform3d(
		// 		new Translation3d(Units.inchesToMeters(-2.5625),
		// 				Units.inchesToMeters(-11.625), Units.inchesToMeters(17.34375)),
		// 		new Rotation3d(0, Units.degreesToRadians(0), 0));
		 ...
		 */
		public static final Matrix<N3, N1> VISION_MEASUREMENT_STANDARD_DEVIATIONS = Matrix
				.mat(Nat.N3(), Nat.N1())
				.fill(
		...
		public static record UnitDeviationParams(double distanceMultiplier, double eulerMultiplier,
				double minimum) {
			private double computeUnitDeviation(double averageDistance) {
				return Math.max(minimum,
						eulerMultiplier * Math.exp(averageDistance * distanceMultiplier));
			}
		}
