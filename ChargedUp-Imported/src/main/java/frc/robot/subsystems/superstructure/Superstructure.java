...
public class Superstructure {
	...
	public Command toStateTeleop(SuperState state) {
		return new SuperstructureToState(this, state, true);
	}

	public Command toStateAuton(SuperState state) {
		return new SuperstructureToState(this, state, false);
	}

	private Command cubeToss(SuperState state, TheClaw claw, boolean auton) {
	...
	public Command cubeTossMid(TheClaw claw, boolean auton) {
		return cubeToss(SuperState.MIDCUBE, claw, auton);
	}

	public Command cubeTossTop(TheClaw claw, boolean auton) {
